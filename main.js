...
return { conversation: "Hola, i'm Shark-Bot" }},   
msgRetryCounterMap,
logger: pino({ level: 'silent' }),
auth: state,
browser: ['Shark-Bot','Edge','1.0.0'],
version   
}       
...
logger: pino({ level: 'silent' }),
auth: state,
browser: ['Shark-Bot','Edge','107.0.1418.26'],
version   
}*/
...
if (opts['autocleartmp'] && (global.support || {}).find) (tmp = [os.tmpdir(), 'tmp', "SharkJadiBot"], tmp.forEach(filename => cp.spawn('find', [filename, '-amin', '4', '-type', 'f', '-delete'])))
}, 30 * 1000)}
