...
//let pp = 'https://i.ibb.co/3fc6F2M/img15.jpg' //'./media/menus/Menu1.jpg'
...
let text = `
*Las funciones | The functions #jadibot #bots #serbot #subbot #getcode. No estan disponibles en | Are not available in* ${sk}`.trim()   
