...
let Terminos = `*_Toda la informacion que se mencione aqui no excluye al Propietario del Bot, y Propietarios Acredores al uso de Del SharkBot_*
*_No Somos responsables del desconocimiento que tenga por parte de esta informacion._* 


*TERMINOS DE PRIVACIDAD*
_- Somos consciente del constante uso que le pueda dar al Bot, y tambien Garantizamos que la informacion como (imagenes, videos, enlaces, ubicacion, Audios, Stickers, Gif, Contactos que Usted Proporcione en torno a Numero(s) Oficial(es) No son ni seran Compartido Con Nadie, ni se usaran dicho Datos fuera del entorno del BOT._
...
_- El chat anonimo del comando #start, valga la redundancia no mostrará ningun dato de los Usuarios por parte del SharkBot. Eso no implica que las personas que hagan uso de esta funcion puedan dar a conocer sus datos. en Numero(s) Oficial(es)._

_- Los Datos que Obtenga SharkBot en Cuentas Oficiales de Usuarios(as), Grupos y Ajustes del Mismo puede verse Reiniciado, Modificado, y/o Retificado con el fin de que el Bot este en optimas Condiciones para su Uso. (Usuarios(as) Pueden Pedir Compensacion Por Instagram o por el comando #Reporte. Debe de Presentar Pruebas)._
...
_- Las Cuentas Oficiales del SharkBot no se hacen responsable del Uso que usted haga con la funcion "Sub Bot"._
...
_- Al hacer uso de ciertos comandos que tengan como objetivo socavar la incomodidad, intranquilidad, molestia u otro termino tajante, se tomarian las respectivas sanciones o llamados de alerta para prevalecer la integridad de los/las Usuarios(as) y funcionamiento del SharkBot._
...
~ _Solo en esta Cuenta Respondo si tiene Dudas, Preguntas o Necesita Ayuda sobre el SharkBot, Tambien puede Comunicarse en Caso de Temas de Colaboracion_
*${ig}*

*~ Muchas Gracias Por tomarte el tiempo en informate sobre El SharkBot*` 
await conn.sendFile(m.chat, pp, 'shark.mp4', Terminos)
}
