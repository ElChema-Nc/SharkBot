...
`
await conn.sendFile(m.chat, sharkImg.getRandom(), 'shark.jpg', caption, fkontak)
//await conn.sendButton(m.chat, wm, caption, shark.getRandom(), [['𝗠 𝗘 𝗡 𝗨 ☘️', '/menu']], m, dos.getRandom())
} catch (e) {
