...
const smsUnreg = () => { return `\`\`\`¡¡NECESITAS ESTAR REGISTRADO PARA USAR ESTE COMANDO, ESCRIBE #verificar PARA REGISTRARTE!!\`\`\`` }//VERIFICAR
const smsRestrict = () => { return `\`\`\`¡¡ESTE COMANDO ESTÁ RESTRINGIDO POR MI CREADOR!!\`\`\`` }//RESTRINGIR COMANDO
...
const smsSaludo = () => { return `👋 !HOLA! BIENVENIDO 👋`}
...
const smsLista1 = () => { return `🌟 INFORMACIÓN DEL SHARKBOT 🌟`}
const smsLista2 = () => { return `👺 CREADOR 👺`}
const smsLista3 = () => { return `🚀 VELOCIDAD 🚀`}
const smsLista4 = () => { return `💡 INFORMACIÓN DEL MENÚ 💡`}
const smsLista5 = () => { return `🌀 MENÚ COMPLETO 🌀`}
const smsLista6 = () => { return `🦈 INSTALAR EL SHARKBOT 🦈`}
const smsLista7 = () => { return `🍄 SER SUB BOT 🍄`}
const smsLista8 = () => { return `📄 TÉRMINOS, CONDICIONES Y PRIVACIDAD 📄`}
const smsLista9 = () => { return `🌟 AVENTURA 🌟`}
const smsLista10 = () => { return `🏆 TOP GLOBAL 🏆`}
const smsLista11 = () => { return `🏅 USUARIOS PREMIUM 🏅`}
const smsLista12 = () => { return `🎟️ SER USUARIO PREMIUM 🎟️`}
const smsLista13 = () => { return `🛣️ MISIONES DIARIAS 🛣️`}
const smsLista14 = () => { return `⚗️ MENÚ RPG ⚗️`}
const smsLista15 = () => { return `🏪 TIENDA DE COMPRA Y VENTA 🏪`}
const smsLista16 = () => { return `🎒 INVENTARIO 🎒`}
const smsLista17 = () => { return `🌟 MULTIMEDIA 🌟`}
const smsLista18 = () => { return `📲 MENÚ DE DESCARGAS 📲`}
const smsLista19 = () => { return `🔍 MENÚ DE BUSQUEDAS 🔍`}
const smsLista20 = () => { return `🛰️ MENÚ CONVERTIDOR 🛰️`}
const smsLista21 = () => { return `🧰 MENÚ MODIFICADOR DE AUDIO 🧰`}
const smsLista21_1 = () => { return `🔩 MENU DE HERRAMIENTAS 🔩`}
const smsLista22 = () => { return `🌟 DIVERSIÓN 🌟`}
const smsLista23 = () => { return `🎡 JUEGOS DINÁMICOS 🎡`}
const smsLista24 = () => { return `🔊 MENÚ DE AUDIOS 🔊`}
const smsLista25 = () => { return `🎈 MENÚ DE STICKERS Y FILTROS 🎈`}
const smsLista26 = () => { return `✨ MENÚ DE EFECTOS Y LOGOS ✨`}
const smsLista27 = () => { return `🌅 MENÚ DE LOGOS 2 🌅`}
const smsLista28 = () => { return `⛩️ MEMES RANDOMS : ANIME ⛩️`}
const smsLista29 = () => { return `🔞 MENÚ DE COMANDOS +18 🔞`}
const smsLista30 = () => { return `🌟 AJUSTES 🌟`}
const smsLista31 = () => { return `🔰 MENÚ PARA GRUPOS 🔰`}
const smsLista32 = () => { return `📑 LISTAS DISPONIBLES 📑`}
const smsLista33 = () => { return `⚙️ CENTRO DE CONFIGURACIÓN ⚙️`}
const smsLista34 = () => { return `💎 MENÚ PARA PROPIETARIO 💎`}
...
//_allantilink.js
const smsTextoYT = () => { return '𝗦𝘂𝗽𝗲𝗿 𝗦𝗵𝗮𝗿𝗸𝗕𝗼𝘁 - 𝗪𝗵𝗮𝘁𝘀𝗔𝗽𝗽 '} 
...
const smsSoloOwner = () => { return `𝙀𝙇 𝙋𝙍𝙊𝙋𝙄𝙀𝙏𝘼𝙍𝙄𝙊 𝘿𝙀𝘽𝙀 𝘼𝘾𝙏𝙄𝙑𝘼𝙍 𝙀𝙎𝙏𝘼 𝙁𝙐𝙉𝘾𝙄𝙊𝙉\n*#on restrict*`}
...
const smsCont18 = () => { return `𝙉𝙊 𝙀𝙎𝙏𝘼𝙉 𝘼𝙐𝙏𝙊𝙍𝙄𝙕𝘼𝘿𝘼𝙎 𝙋𝙊𝙍 𝙇𝙊 𝙌𝙐𝙀 𝙏𝙀𝙉𝘿𝙍𝙀 𝙌𝙐𝙀 𝘽𝙇𝙊𝙌𝙐𝙀𝘼𝙍𝙏𝙀\n\n𝙎𝙄 𝙇𝙇𝘼𝙈𝘼𝙎𝙏𝙀 𝙋𝙊𝙍 𝘼𝘾𝘾𝙄𝘿𝙀𝙉𝙏𝙀 𝘾𝙊𝙈𝙐𝙉𝙄𝘾𝘼𝙏𝙀 𝘾𝙊𝙉 𝙇𝘼 𝙋𝙀𝙍𝙎𝙊𝙉𝘼 𝙋𝙍𝙊𝙋𝙄𝙀𝙏𝘼𝙍𝙄𝙊 𝘿𝙀 𝙀𝙎𝙏𝙀 𝘽𝙊𝙏\n𝙎𝙄 𝙀𝙎 𝙐𝘼 𝘾𝙐𝙀𝙉𝙏𝘼 𝙊𝙁𝙄𝘾𝙄𝘼𝙇 𝘿𝙀 𝙎𝙃𝘼𝙍𝙆𝘽𝙊𝙏 𝘿𝙄𝙍𝙄𝙂𝙀𝙏𝙀 𝘼 𝙇𝘼 𝘼𝙎𝙄𝙎𝙏𝙀𝙉𝘾𝘼 𝙋𝙊𝙍 𝙄𝙉𝙎𝙏𝘼𝙂𝙍𝘼𝙈 𝙋𝘼𝙍𝘼 𝙏𝙍𝘼𝙏𝘼𝙍 𝙎𝙐 𝘾𝘼𝙎𝙊\n*${global.ig}*`}
...
//_antilink.js
const smsAdwa = () => { return `${global.lenguajeGB['smsAvisoEG']()}𝘾𝙊𝙈𝙊 𝙀𝙍𝙀𝙎 𝘼𝘿𝙈𝙄𝙉 𝙀𝙉 𝙀𝙇 𝙂𝙍𝙐𝙋𝙊 𝙉𝙊 𝙎𝙀𝙍𝘼𝙎 𝙀𝙇𝙄𝙈𝙄𝙉𝘼𝘿𝙊`}
...
const smsToxic2 = () => { return `𝙀𝙎𝙏𝘼 𝙋𝙍𝙊𝙃𝙄𝘽𝙄𝘿𝘼 𝙉𝙊 𝙎𝙀𝘼𝙎 𝙏𝙊𝙓𝙄𝘾𝙊`}
...
const smsToxic7 = () => { return `𝙎𝙐𝙋𝙀𝙍𝘼𝙎𝙏𝙀 𝙇𝘼𝙎 4 𝘼𝘿𝙑𝙀𝙍𝙏𝙀𝙉𝘾𝙄𝘼𝙎 𝘼𝙃𝙊𝙍𝘼 𝙎𝙀𝙍𝘼𝙎 𝙀𝙇𝙄𝙈𝙄𝙉𝘼𝘿𝙊 🙄`}
...
const eSharkCoins = () => { return '🦈 SharkCoins' }
const eSharkTickers = () => { return '🎫 Shark Tickers' } 
...
const smsModP2 = () => { return `Habilitar función para que todos puedan usar SharkBot`}
const smsModAd1 = () => { return `🛂 MODO ADMIN`}
const smsModAd2 = () => { return `Solo los Admins podrán usar SharkBot en Grupos`}
...
const smsAfkM1B = () => { return `*ESTARÁ INACTIVO AFK*\n\n*MOTIVO DE LA INACTIVIDAD AFK:*`} 
...
const smsChatAn12 = () => { return `❇️ OTRO USUARIO`} 
...
const smsAdveu8 = () => { return '*AHORA SERÁS ELIMINADO* 🙄'}
...
const smskick2 = () => { return `ELIMINADO 🫵`}
...
//propietario(a).js
const smsJoin = (user) => { return `${packname}\n𝙀𝙎 𝙐𝙉𝘽𝙊𝙏 𝘿𝙀 𝙒𝙃𝘼𝙏𝙎𝘼𝙋𝙋 𝙌𝙐𝙀 𝙏𝙀 𝘼𝙔𝙐𝘿𝘼𝙍𝘼 𝙍𝙀𝘼𝙇𝙄𝙕𝘼𝙍 𝘿𝙄𝙁𝙀𝙍𝙀𝙉𝙏𝙀𝙎 𝘼𝘾𝙏𝙄𝙑𝙄𝘿𝘼𝘿𝙀𝙎 🪄 𝘼𝙇 𝙋𝙍𝙄𝙑𝘼𝘿𝙊 𝙊 𝙂𝙍𝙐𝙋𝙊 𝙔 𝙏𝘼𝙈𝘽𝙄𝙀𝙉 𝙏𝙀 𝙑𝘼𝙎 𝘼 𝘿𝙄𝙑𝙀𝙍𝙏𝙄𝙍 🎈 𝘾𝙊𝙉 𝙎𝙐𝙎 𝙈𝙐𝙇𝙏𝙄𝙋𝙇𝙀𝙎 𝙁𝙐𝙉𝘾𝙄𝙊𝙉𝙀𝙎, 𝘿𝙄𝙎𝙁𝙍𝙐𝙏𝘼 𝘿𝙀 𝙎𝙃𝘼𝙍𝙆𝘽𝙊𝙏!!!\n\n😵‍💫 𝙎𝙃𝘼𝙍𝙆𝘽𝙊𝙏 𝙁𝙐𝙀 𝙄𝙉𝙑𝙄𝙏𝘼𝘿𝙊 𝙋𝙊𝙍:\n@${user}`}
...
const smsPropban5 = () => { return `${lenguajeGB['smsAvisoEG']()}𝙀𝙇 𝙐𝙎𝙐𝘼𝙍𝙄𝙊 𝙁𝙐𝙀 𝘽𝘼𝙉𝙀𝘼𝘿𝙊 🦈\n𝙉𝙊 𝙋𝙊𝘿𝙍𝘼 𝙐𝙎𝘼𝙍 𝘼 ${sk}`}
...
const smsSoloOwnerJB = () => { return `${lenguajeGB['smsAvisoAG']()}*ESTE COMANDO ESTÁ DESACTIVADO POR MÍ PROPIETARIO*`}
...
const smsJBCargando = () => { return `${lenguajeGB['smsAvisoIIG']()}⚪ *ESTÁ CONECTADO!! POR FAVOR ESPERE SE ESTÁ CARGANDO LOS MENSAJES...*\n\n♻️ *OPCIONES DISPONIBLES:*\n*» #stop _(Detener la función Sub Bot)_*\n*» #eliminarsesion _(Borrar todo rastro de Sub Bot)_*\n*» #serbot _(Obtener nuevo código QR para ser Sub Bot)_*`}
const smsJBInfo1 = () => { return `🫡 *ENLACE ÚTIL*`}
const smsJBInfo2 = () => { return `🫡 *La función es estable, sí presenta algún inconveniente Comuníquese al correo: ja82783643@gmail.com*\n\n*Muchas Gracias por el apoyo a ${global.packname}*`}
...
const smsContAdult = () => { return `${lenguajeGB['smsAvisoAG']()}*LOS COMANDOS 🔞 ESTÁN DESACTIVADOS, SI USTED ES MI CREADOR USE #on modohorny*`}
...
const smsContacto4 = () => { return 'Contacto Oficial de SharkBot 🦈'}
...
smsGI1, smsGI2, smsGI3, smsGI4, smsGI5, smsGI6, smsGI7, smsGI8, smsGI9, smsGI10, smsLista21_1, smsCodigoQR, smsConexionOFF, smskick1, smskick2, smskick3, smskick4, smstagaa,
